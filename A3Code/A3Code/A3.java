...
public class A3  extends JFrame {
	...
	class AddListener implements ActionListener {
		public void actionPerformed( ActionEvent e) {
		    ...
		    if (selectedNode != null) {
		        if (selectedNode instanceof NestedShape) bouncingPanel.addShapeNode((NestedShape)selectedNode);
		        else JOptionPane.showMessageDialog(null,"ERROR: Must select a NestedShape node.");
		    }
		    else JOptionPane.showMessageDialog(null,"ERROR: No node selected.");
		}
	}
	...
	class RemoveListener implements ActionListener {
		public void actionPerformed( ActionEvent e) {
		    Object selectedNode = tree.getLastSelectedPathComponent();
		    if (selectedNode != null) {
		    	if (!bouncingPanel.isRoot((Shape)selectedNode)) bouncingPanel.removeNodeFromParent((Shape)selectedNode);
		    	else JOptionPane.showMessageDialog(null,"ERROR: Must not remove the root.");
		    }
		    else JOptionPane.showMessageDialog(null,"ERROR: No node selected.");
		}
	}
